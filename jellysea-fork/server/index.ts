...
app
  ...
  .then(async () => {
    ...
    server.use('/proxy', proxyRoutes);
    server.use('/api/v1/stream', checkUser, isAuthenticated(), streamRoutes);
    ...
    server.use('/api/v1/media', checkUser, isAuthenticated(), playRoutes);
