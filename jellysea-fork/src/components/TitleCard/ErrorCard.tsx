...
const ErrorCard = ({ id, tmdbId, tvdbId, type, canExpand }: ErrorCardProps) => {
  ...
  return (
    ...
    >
      <div
        className="relative transform-gpu cursor-default overflow-hidden rounded-xl bg-dark-900 bg-cover shadow outline-none ring-1 ring-dark-600 transition duration-300"
        style={{
          paddingBottom: '150%',
        }}
      >
        <div className="absolute inset-0 h-full w-full overflow-hidden">
          <div className="absolute left-0 right-0 flex items-start justify-between p-2">
            <div className="pointer-events-none z-40 rounded bg-dark/70 px-2 py-0.5 text-xs font-medium uppercase tracking-wider text-white">
              {type === 'movie'
