...
const DiscoverTv = () => {
  ...
  const mediaStatus = router.query.mediaStatus as string | undefined;
  const filteredTitles = useMemo(() => {
    if (!mediaStatus || !titles) return titles;
  ...
  const activeCount = countActiveFilters(preparedFilters) + (mediaStatus ? 1 : 0);
