...
exports.AddTelegramSettingsToUserSettings1614334195680 = void 0;
class AddTelegramSettingsToUserSettings1614334195680 {
    constructor() {
        this.name = 'AddTelegramSettingsToUserSettings1614334195680';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`INSERT INTO "temporary_user_settings"("id", "enableNotifications", "discordId", "userId", "region", "originalLanguage") SELECT "id", "enableNotifications", "discordId", "userId", "region", "originalLanguage" FROM "user_settings"`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`INSERT INTO "user_settings"("id", "enableNotifications", "discordId", "userId", "region", "originalLanguage") SELECT "id", "enableNotifications", "discordId", "userId", "region", "originalLanguage" FROM "temporary_user_settings"`);
        await queryRunner.query(`DROP TABLE "temporary_user_settings"`);
    }
}
exports.AddTelegramSettingsToUserSettings1614334195680 = AddTelegramSettingsToUserSettings1614334195680;
