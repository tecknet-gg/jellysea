...
exports.UpgradeConnectTypeORM1777045861167 = void 0;
class UpgradeConnectTypeORM1777045861167 {
    constructor() {
        this.name = 'UpgradeConnectTypeORM1777045861167';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_session" ("expiredAt" bigint NOT NULL, "id" varchar(255) PRIMARY KEY NOT NULL, "json" text NOT NULL, "destroyedAt" datetime)`);
        await queryRunner.query(`INSERT INTO "temporary_session"("expiredAt", "id", "json") SELECT "expiredAt", "id", "json" FROM "session"`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`INSERT INTO "session"("expiredAt", "id", "json") SELECT "expiredAt", "id", "json" FROM "temporary_session"`);
...
exports.UpgradeConnectTypeORM1777045861167 = UpgradeConnectTypeORM1777045861167;
