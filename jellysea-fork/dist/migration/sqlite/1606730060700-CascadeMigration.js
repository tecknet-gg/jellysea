...
exports.CascadeMigration1606730060700 = void 0;
class CascadeMigration1606730060700 {
    constructor() {
        this.name = 'CascadeMigration1606730060700';
    }
    async up(queryRunner) {
        await queryRunner.query(`CREATE TABLE "temporary_season_request" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "seasonNumber" integer NOT NULL, "status" integer NOT NULL DEFAULT (1), "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "updatedAt" datetime NOT NULL DEFAULT (datetime('now')), "requestId" integer)`);
        ...
        await queryRunner.query(`INSERT INTO "temporary_season"("id", "seasonNumber", "status", "createdAt", "updatedAt", "mediaId") SELECT "id", "seasonNumber", "status", "createdAt", "updatedAt", "mediaId" FROM "season"`);
    ...
    async down(queryRunner) {
        ...
        await queryRunner.query(`INSERT INTO "season"("id", "seasonNumber", "status", "createdAt", "updatedAt", "mediaId") SELECT "id", "seasonNumber", "status", "createdAt", "updatedAt", "mediaId" FROM "temporary_season"`);
...
exports.CascadeMigration1606730060700 = CascadeMigration1606730060700;
