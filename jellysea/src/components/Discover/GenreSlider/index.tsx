...
import GenreCard, { GenreCardPlaceholder } from '@/components/GenreCard'
import { genreColorMap } from '@/utils/genreColors'
import type { GenreSliderItem } from '@/utils/types'
