...
import type { MovieResult, Genre, DiscoverFiltersState } from '@/utils/types'
...
export default function DiscoverMovies() {
  ...
  const apiParams = useMemo(() => {
    ...
    if (filters.yearGte) params.primaryReleaseDateGte = `${filters.yearGte}-01-01`
    if (filters.yearLte) params.primaryReleaseDateLte = `${filters.yearLte}-12-31`
  ...
  const { titles, isLoading, isLoadingMore, isReachingEnd, isEmpty, fetchMore } =
    useDiscover<MovieResult>('/discover/movies', apiParams)
